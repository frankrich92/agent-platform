package com.htam.agent.job.core.cluster;
...
import com.htam.agent.job.core.cluster.message.JobControlMessage;
...
public class JobMessagePublisher {
     ...
     * @param jobInfo 任务信息
     */
    public void publishAdd(com.htam.agent.common.entity.JobInfo jobInfo) {
     ...
     * @param jobInfo 任务信息
     */
    public void publishUpdate(com.htam.agent.common.entity.JobInfo jobInfo) {
