package com.htam.agent.resource.storage.core;

import com.htam.agent.common.util.JsonUtils;
import com.htam.agent.resource.enums.ProtocolType;
import com.htam.agent.resource.storage.config.AmazonS3Config;
import com.htam.agent.resource.storage.config.FtpStorageConfig;
import com.htam.agent.resource.storage.config.LocalStorageConfig;
import com.htam.agent.resource.storage.core.service.AmazonS3StorageService;
import com.htam.agent.resource.storage.core.service.FtpFileStorageService;
import com.htam.agent.resource.storage.core.service.LocalFileStorageService;
