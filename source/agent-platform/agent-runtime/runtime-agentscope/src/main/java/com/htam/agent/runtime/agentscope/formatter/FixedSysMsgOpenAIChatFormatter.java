package com.htam.agent.runtime.agentscope.formatter;
 ...
 * @author huxuehao
 */
public class FixedSysMsgOpenAIChatFormatter extends OpenAIChatFormatter {

    public FixedSysMsgOpenAIChatFormatter() {
        super();
    }
