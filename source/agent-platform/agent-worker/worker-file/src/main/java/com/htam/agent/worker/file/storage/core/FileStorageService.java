package com.htam.agent.worker.file.storage.core;

import com.htam.agent.common.util.JsonUtils;
import com.htam.agent.worker.file.enums.ProtocolType;
import com.htam.agent.worker.file.storage.config.AmazonS3Config;
import com.htam.agent.worker.file.storage.config.FtpStorageConfig;
import com.htam.agent.worker.file.storage.config.LocalStorageConfig;
import com.htam.agent.worker.file.storage.core.service.AmazonS3StorageService;
import com.htam.agent.worker.file.storage.core.service.FtpFileStorageService;
import com.htam.agent.worker.file.storage.core.service.LocalFileStorageService;
