...
INSERT INTO `tool_config` (`id`, `name`, `tool_id`, `description`, `category`, `tool_type`, `input_schema`, `output_schema`, `class_path`, `language`, `code`, `need_confirm`, `enabled`, `version`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (2020017365391609857, 'get_current_datetime', 'get_current_datetime', '获取当前的日期时间', '通用', 'BUILTIN', '[{\"name\":\"format\",\"description\":\"日期时间格式，默认值 yyyy-MM-dd HH:mm:ss\",\"type\":\"string\",\"defaultValue\":null,\"required\":false}]', NULL, 'com.htam.agent.core.tool.builtins.GetCurrentTimeTool', NULL, NULL, 0, 1, '1.0.0', '2026-02-07 14:10:45', '2026-03-02 14:34:27', NULL, 0);
