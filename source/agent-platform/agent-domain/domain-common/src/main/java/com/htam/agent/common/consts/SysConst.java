...
import com.htam.agent.common.runtime.AgentRuntimeProperties;
...
public class SysConst {
    ...
    public static final String ALLOW_SKILL_FILE_TYPE =
            "txt,md,markdown,csv,tsv,json,yaml,yml,xml,html,htm,pdf,doc,docx,xls,xlsx,ppt,pptx,zip,log,sql";
    ...
    public static final String WORKSPACE_DIR_NAME = AgentRuntimeProperties.WORKSPACES_DIR;
    public static final String WORKSPACE_PATH = RuntimePaths.workspacesString();
    public static final String SKILLS_DIR_NAME = AgentRuntimeProperties.SKILLS_DIR;
    public static final String SKILLS_DIR = RuntimePaths.skillsString();
