...
import com.htam.agent.common.config.mybatis.JsonNodeTypeHandler;
import com.htam.agent.common.consts.TableConst;
import com.htam.agent.common.enums.AgentType;
import com.htam.agent.common.enums.StructuredOutputReminderMode;
import com.htam.agent.common.enums.ToolChoiceStrategy;
...
public class AgentDefinition extends BaseEntity {
     ...
     * 结构化输出模式
     */
    private StructuredOutputReminderMode structuredOutputReminder;
