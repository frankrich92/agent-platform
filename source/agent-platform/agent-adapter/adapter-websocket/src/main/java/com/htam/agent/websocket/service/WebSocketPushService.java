...
public class WebSocketPushService {
    ...
    public void pushToClientCluster(String clientId, WsServerMessage message) {
        try {
            ...
            redisSessionManager.broadcastMessage("agent:ws:cluster:message", messageStr);
    ...
    public void pushToUserCluster(String userId, WsServerMessage message) {
        try {
            ...
            String messageStr = JsonUtils.toJsonStr(clusterMsg);
            redisSessionManager.broadcastMessage("agent:ws:cluster:user:" + userId, messageStr);
    ...
    public void pushToUserCodeCluster(String userCode, WsServerMessage message) {
        try {
            ...
            String messageStr = JsonUtils.toJsonStr(clusterMsg);
            redisSessionManager.broadcastMessage("agent:ws:cluster:usercode:" + userCode, messageStr);
    ...
    public void broadcastCluster(WsServerMessage message) {
        try {
            ...
            String messageStr = JsonUtils.toJsonStr(clusterMsg);
            redisSessionManager.broadcastMessage("agent:ws:cluster:broadcast", messageStr);
