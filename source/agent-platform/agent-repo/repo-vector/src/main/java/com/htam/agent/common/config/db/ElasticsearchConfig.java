...
public class ElasticsearchConfig {
    ...
    public RestClient elasticsearchRestClient(
        ...
        RestClientBuilder builder = RestClient.builder(parseHosts(uris))
        ...
        log.info("Elasticsearch客户端初始化完成, uris={}", uris);
        return client;
    }

    HttpHost[] parseHosts(String uris) {
    ...
    Header buildAuthHeader(String username, String password, String apiKey) {
